                ...
                <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
                    ...
                    <div className="mt-6 space-y-4">
                        ...
                        <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                            ...
                            <div className="text-sm font-medium text-gray-900">
                                {isMounted ? formatPrice(fee, {notation: "standard"}) : 
                                    (<Loader2 className="h-4 w-4 animate-spin text-muted-foreground"/>)
                                }
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                            ...
                            <div className="text-base font-medium text-gray-900">
                                {isMounted ? formatPrice((cartTotal + fee), {notation: "standard"}) : 
                                    (<Loader2 className="h-4 w-4 animate-spin text-muted-foreground"/>)
                                }
                            </div>
                        </div>
                    ...
                    <div className="mt-6">
                        <Button disabled={items.length === 0 || isLoading}  
                            onClick={() => createCheckoutSession({productIds})} className="w-full" size='lg'>
